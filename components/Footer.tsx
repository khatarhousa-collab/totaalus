            ...
            <div className="space-y-8">
              <div className="p-6 bg-black/50 rounded-3xl border border-amber-900/20">
                <p className="text-sm font-medium leading-relaxed text-white/80">
                  IPTVTotaal helpt duizenden klanten met premium IPTV. Voor snelle service, WhatsApp ons voor een reactie binnen 5 minuten, bel <a href="tel:+447414662070" className="text-amber-400 font-bold hover:underline">+44 7414 662070</a> of mail <a href="mailto:info@iptvtotaal.watch" className="text-amber-400 font-bold hover:underline">info@iptvtotaal.watch</a>.
                </p>
              </div>
