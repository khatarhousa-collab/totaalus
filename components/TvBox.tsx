        ...
        <div className="mb-24">
          ...
          <div className="mt-10 glass-card rounded-2xl border border-white/10 p-6 sm:p-8 max-w-xl mx-auto space-y-5">
            ...
            <form onSubmit={handleSubmitReview} className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full inline-flex items-center justify-center gap-2 h-12 rounded-xl bg-[#25D366] text-black font-bold hover:opacity-90 active:scale-95 transition-all"
              >
