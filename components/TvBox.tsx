    ...
    <div className="min-h-screen bg-gradient-to-b from-neutral-950 to-black">
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-start">
            ...
            <div className="flex flex-col gap-4">
              ...
              >
                ...
                <div className="absolute bottom-4 left-1/2 -translate-x-1/2 px-4 py-2 rounded-full bg-gradient-to-r from-amber-500 to-yellow-600 text-black text-xs font-black uppercase tracking-widest shadow-lg text-center whitespace-nowrap">
        ...
        <div className="mb-24">
          ...
          <div className="mt-10 glass-card rounded-2xl border border-white/10 p-6 sm:p-8 max-w-xl mx-auto space-y-5">
            ...
            <form onSubmit={handleSubmitReview} className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full inline-flex items-center justify-center gap-2 h-12 rounded-xl bg-gradient-to-r from-amber-500 to-yellow-600 text-black font-bold hover:opacity-90 active:scale-95 transition-all"
              >
        ...
        <div className="mb-24 max-w-3xl mx-auto">
          ...
          <div className="mt-10 glass-card rounded-2xl border border-white/10 p-6 sm:p-8 max-w-xl mx-auto text-center space-y-4">
            ...
            <form onSubmit={handleAskQuestion} className="flex flex-col sm:flex-row gap-3">
              ...
              <button
                type="submit"
                className="inline-flex items-center justify-center gap-2 px-6 h-12 rounded-xl bg-[#25D366] text-black font-bold hover:opacity-90 active:scale-95 transition-all flex-shrink-0"
              >
      ...
      >
        ...
        >
          ...
          <button
            onClick={handleOrder}
            className="flex-1 h-12 rounded-xl bg-gradient-to-r from-amber-500 to-yellow-600 text-black font-black text-base active:scale-95 transition-transform"
          >
            Bestel nu
          </button>
        </div>
