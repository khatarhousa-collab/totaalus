      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-12 text-gray-700 leading-relaxed">
          ...
          <section>
            ...
            <ol className="list-decimal pl-6 space-y-2">
              <li>Klachten kunnen worden ingediend via WhatsApp of e-mail op <a href="mailto:info@iptvtotaal.us" className="text-amber-500 font-bold hover:underline">info@iptvtotaal.us</a>.</li>
